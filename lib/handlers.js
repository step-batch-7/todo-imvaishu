...
const addTodo = function(req, res){
  const {titleText} = querystring.parse(req.body);
...
const addSubTask = function(req, res){
  const {todoId, titleText} = querystring.parse(req.body);
...
const removeSubtask = function(req, res){
  const {todoId, subtaskId} = querystring.parse(req.body); 
  const todo = todoList.findTodo(todoId);
...
const updateSubtaskStatus = function(req, res){
  const {todoId, subtaskId, status} = querystring.parse(req.body);
  const todo = todoList.findTodo(todoId);
